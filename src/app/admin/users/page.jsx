...
export default function AdminUsers() {
  ...
  return (
    <div className="px-8 py-12 lg:px-14 xl:px-24 lg:pt-24 w-full">
      ...
      <div
        className={`fixed z-20 left-0 right-0 top-0 bottom-0 m-auto w-[90%] h-[65%] sm:w-[70%] md:w-[50%] lg:w-[40%] xl:w-[30%] bg-white py-6 px-8 sm:px-16 xl:px-18 overflow-y-auto ${
          show ? 'block' : 'hidden'
        }`}
      >
        <form className="h-full flex flex-col justify-between py-6" ref={form} onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <button onClick={() => setShow(!show)} className="border-gray-500 border-2 text-gray-600 py-2 px-5 rounded-full w-full mb-6">
              Cancelar
            </button>
          </div>
        </form>
